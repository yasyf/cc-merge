...
[![PolyForm Noncommercial license](https://img.shields.io/badge/License-PolyForm--Noncommercial--1.0.0-blue.svg)](https://github.com/yasyf/cc-merge/blob/main/LICENSE)
...
cc-merge is an early scaffold today. The CLI installs and runs; the queue engine is what lands next. Licensed under [PolyForm Noncommercial 1.0.0](LICENSE).
